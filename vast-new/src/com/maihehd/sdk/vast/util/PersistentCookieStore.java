...
public class PersistentCookieStore implements CookieStore {
        ...
        for(Map.Entry<String, ?> entry : prefsMap.entrySet()) {
            if (((String)entry.getValue()) != null && !((String)entry.getValue()).startsWith(COOKIE_NAME_PREFIX)) {
                ...
                for (String name : cookieNames) {
                    //LogUtil.d(TAG, "loading saved cookie named " + name);
    ...
    protected String encodeCookie(SerializableHttpCookie cookie) {
        ...
        try {
            ...
            LogUtil.d(TAG, "IOException in encodeCookie" + e.toString());
            return null;
        }
    ...
    protected HttpCookie decodeCookie(String cookieString) {
        ...
        try {
            ...
            LogUtil.d(TAG, "IOException in decodeCookie " + e.toString());
        } catch (ClassNotFoundException e) {
            LogUtil.d(TAG, "ClassNotFoundException in decodeCookie " + e.toString());
        }
